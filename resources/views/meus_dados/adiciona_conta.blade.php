...
<div class="card text-dark bg-light mb-3">
    <div class="card-header">
        <h6 class="card-title">
            <i class="fas fa-calculator me-2"></i>Adicionar dados bancários
        </h6>
    </div>
    <div class="card-body">
        <div class="row card-text">
            <form action="{{route('meus_dados.adiciona_conta.store')}}" method="post">
                ...
                <div class="row mt-3">
                    <div class="col-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="agencia" id="agencia" placeholder="agencia" autocomplete="off" value="{{(old('agencia'))}}">
                    ...
                    <div class="col-2">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="operacao" id="operacao" placeholder="operacao" autocomplete="off" value="{{(old('operacao'))}}">
                    ...
                    <div class="col-5">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="pix" id="pix" placeholder="pix" autocomplete="off" value="{{(old('pix'))}}">
